# Generated by Django 5.0.4 on 2025-04-11 07:17
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('driver', 'Driver'), ('lorry_owner', 'Lorry Owner'), ('business', 'Business Person'), ('admin', 'Admin')], default='driver', max_length=20)),
        ...
        migrations.CreateModel(
            name='LorryOwnerProfile',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('company_name', models.CharField(max_length=100)),
                ('number_of_vehicles', models.IntegerField()),
                ('business_registration_number', models.CharField(max_length=50)),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='lorry_owner_profile', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
